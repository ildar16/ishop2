    ...
    <div class="container">
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price" id="base-price" data-base="<?= $product->old_price * $curr['value']; ?>"><?=$curr['symbol_left']?><?= $product->price * $curr['value']; ?><?=$curr['symbol_right']?></h5>
                            <?php if ($product->old_price): ?>
                                <s><small><?=$curr['symbol_left']?><?= $product->old_price * $curr['value']; ?><?=$curr['symbol_right']?></small></s>
                            <?php endif; ?>
                            <p><?= $product->content?></p>
                            <?php if ($mods): ?>
                            <div class="available">
                            ...
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <?php if ($item['old_price']): ?>
                                        <s><small><?=$curr['symbol_left']?><?= $item['old_price'] * $curr['value']; ?><?=$curr['symbol_right']?></small></s>
                                    <?php endif; ?>
                                </div>
                                <div class="srch">
                                    <span>-50%</span>
                ...
                <?php if($recenltyViewed): ?>
                <div class="latestproducts">
                    <div class="product-one">
                        <h3>Вы недвано смотрели:</h3>
                        <?php foreach ($recenltyViewed as $item): ?>
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="product/<?=$item['alias'];?>" class="mask"><img class="img-responsive zoom-img" src="images/<?=$item['img'];?>" alt="" /></a>
                                <div class="product-bottom">
