...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=ADMIN;?>/user"><i class="fa fa-user"></i> Редактирование пользователя</a></li>
    </ol>
</section>
...
//                                $class = $order['status'] ? 'success' : '';
                                ...
                                <tr class="<?=$class?>">
                                    ...
                                    <td><a href="<?=ADMIN;?>/order/view?id=<?=$order['id'];?>"><i class="fa fa-fw fa-eye"></i></a> <a href="<?=ADMIN;?>/order/delete?id=<?=$order['id'];?>"><i class="fa fa-fw fa-close delete text-danger"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
